...
*/
jQuery(document).ready(function(a){a("form[data-form-ajax]").on("submit",function(b){function c(){a.ajax({type:d.attr("method"),url:d.attr("action"),data:d.serialize(),dataType:"json",encode:!0}).done(function(a){a.success?(e.prop("disabled",!1).text("Email sent!"),"undefined"!=typeof f&&f!==!1?window.location=f:"undefined"!=typeof i&&i!==!1?d.append('<div class="alert alert-success form-status">'+i+"</div>"):d.append('<div class="alert alert-success form-status">'+a.success+"</div>")):d.append('<div class="alert alert-danger form-status">Oops something went wrong. Email us at <a href="mailto:'+j+'">'+j+"</a>.</div>")})}var d=a(this),e=a('[type="submit"]',d),f=d.attr("data-form-redirect"),g=d.attr("data-form-geolocation"),h="",i=d.attr("data-form-success"),j=d.attr("action").match(/([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9._-]+)/gi);e.prop("disabled",!1).text("Sending..."),"undefined"!=typeof g&&g!==!1?a.ajax({dataType:"json",url:g,timeout:5e3}).done(function(b){a.each(b,function(a,b){h+='<input type="hidden" name="geodata_'+a+'" value="'+b+'">'}),d.append(h)}).fail(function(a,b,c){console.warn("AJAX error!",c),console.log(a)}).always(function(){c()}):c(),b.preventDefault()})});